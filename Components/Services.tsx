...
export default function Services () {
    return (
        <div className="flex flex-col items-center bg-[#101010] text-white" >
            <h1 className="text-3xl mt-10 font-bold lg:text-7xl">My Services</h1>

            <div className="flex flex-col gap-10 mt-10 mx-auto lg:flex-row">
                <div className="flex flex-col max-w-[300px] bg-[#191919] p-3 rounded-md items-center lg:max-h-[600px]">
                    <span>
                        <Image src={WebDev} alt="Web-Dev-Img" className="w-75 h-40 rounded-md" />
                    </span> 
                    ...
                    <button className="bg-red-500 py-3 px-5 rounded-full font-bold mt-10 hover:bg-transparent border-3 border-red-500 cursor-pointer">Read More</button>

                </div>

               <div className="flex flex-col max-w-[300px] bg-[#191919] p-3 rounded-md items-center lg:max-h-[500px]">
                    <span>
               ...
               <div className="flex flex-col max-w-[300px] bg-[#191919] p-3 rounded-md items-center lg:max-h-[500px]">
                    <span>
                        <Image src={Desktop} alt="Web-Dev-Img" className="w-75 rounded-md" />
                    </span> 
